...
from .views import ListBook, CreateBook , InspectBook, DeleteBook, EditBook , LoanBook , ReturnBook , ListBookByUser , SearchView , PanelView
...
path('search_book', SearchView.as_view(),name='search_view'),
